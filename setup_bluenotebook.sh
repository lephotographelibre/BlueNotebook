...
### Titre 3</code></pre>
                ...
                <ul>
                    ...
                    <li>Liens : <code>texte</code></li>
                    <li>Images : <code>!alt</code></li>
...
class MarkdownParser:
    ...
    def to_html(self, markdown_text):
        ...
        try:
            # Réinitialiser le parser avant chaque conversion
            self.md.reset()
...
# Coloration syntaxique pour le code dans l'aperçu
Pygments>=2.15.0
...
- **CSS de l'aperçu** : Modifier `gui/preview.py` dans la méthode `create_html_template`
...
def test_file_handler_read_write():
    ...
    try:
        # Test écriture
        FileHandler.write_file(temp_path, content)

        # Test lecture
        read_content = FileHandler.read_file(temp_path)
        assert read_content == content
        
        # Test écriture d'un nouveau contenu
...
echo "   - Placez votre icône dans 'resources/icons/'"
echo "   - Nommez-la 'bluenotebook.ico' ou 'bluenotebook.png'"
echo ""

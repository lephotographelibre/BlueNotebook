...
class DateRangeDialog(QDialog):
    ...
    def get_export_options(self) -> dict:
        ...
        return {
            self.tr("start_date"): self.start_date_edit.date(),
            self.tr("end_date"): self.end_date_edit.date(),
            self.tr("title"): self.title_edit.text(),
            self.tr("author"): self.author_edit.text(),
            self.tr("cover_image"): self.cover_image_path,
            self.tr("selected_tag"): selected_tag if selected_tag != self.tr("(Aucun tag)") else None,
        }

    ...
    def run(self):
        ...
        try:
            with zipfile.ZipFile(
                self.backup_path, self.tr("w"), zipfile.ZIP_DEFLATED
                ...
                for root, dirs, files in os.walk(self.journal_directory):
                    ...
                    if self.tr("__pycache__") in dirs:
                        dirs.remove(self.tr("__pycache__"))

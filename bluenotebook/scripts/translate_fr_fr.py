# Translation (FR-FR) complete. Output file: bluenotebook_fr_translated.ts"
# Copie le <source> en français sur le <translation> sans traduction juste pour avoir ce fchier valide et qu'il puisse etre compilé

# Arborescence des Menus de BlueNotebook V2.3.1
...
➕ Insérer
├── 🖼️ Image (<img ...>) : Insère une image via une balise HTML `<img>`.
├── 🖼️ Image Markdown : Insère une image avec la syntaxe Markdown `!`.
